...
void ButtonChannel::setup(input::MouseState* mouseState, input::KeyboardState* keyboardState)
{
...
void ButtonChannel::update(float dt, input::MouseState* mouseState, input::KeyboardState* keyboardState)
{
    if( _smoothMode )
    {
