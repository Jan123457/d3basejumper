...
void MouseChannel::setup(input::MouseState* mouseState, input::KeyboardState* keyboardState)
{
}
...
void MouseChannel::update(float dt, input::MouseState* mouseState, input::KeyboardState* keyboardState)
{
    _amplitude = 0.0f;
    if( dt == 0.0f ) return;
    switch( _axis )
