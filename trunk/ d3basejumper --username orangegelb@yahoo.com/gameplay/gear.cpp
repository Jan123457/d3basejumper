...
Vector4f Gear::getGearColor(void)
{
    ...
    switch( colorId )
    {
    case 156: result.set( 57,49,85,255 ); break; // "Òåìíî-ñèíèé",
    case 157: result.set( 82,49,82,255 ); break; // "Ïóğïóğíûé",
    case 158: result.set( 74,89,49,255 ); break; // "Õàêè",
    case 159: result.set( 49,73,90,255 ); break; // "Ñèğåíåâûé",
    case 160: result.set( 173,170,0,255 ); break; // "Æåëòûé",
    case 161: result.set( 236,82,71,255 ); break; // "ßğêî-êğàñíûé",
    case 162: result.set( 80,115,233,255 ); break; // "Ñâåòëî-ñèíèé",
    case 163: result.set( 88,158,55,255 ); break; // "Ñâåòëî-çåëåíûé",
    case 164: result.set( 203,105,0,255 ); break; // "Îğàíæåâûé",
    case 165: result.set( 208,206,208,255 ); break; // "Áåëûé",
    case 166: result.set( 181,47,16,255 ); break; // "Ìàëèíîâûé",
    case 167: result.set( 197,16,99,255 ); break; // "Ñâåòëî-ôèîëåòîâûé",
    case 168: result.set( 148,61,151,255 ); break; // "Ôèîëåòîâûé",
    case 169: result.set( 16,97,25,255 ); break; // "Òåìíî-çåëåíûé",
    case 230: result.set( 8,8,8,255 ); break; // "×åğíûé",
    }
    result *= ( 1.0f / 255.0f );
    return result;
}
